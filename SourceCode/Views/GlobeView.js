...
var BaseGlobeView = Marionette.ItemView.extend({
	tagName: "div",
...
var GlobeView = BaseGlobeView.extend({

	// framework methods

	initialize: function() {
		BaseGlobeView.prototype.initialize.call(this);
	...
	onShow: function() {
		BaseGlobeView.prototype.onShow.call(this);
	},

	// member methods

 	showGlobe: function() {
 		BaseGlobeView.prototype.showGlobe.call(this);
    },
    drawGlobe: function() {
    	BaseGlobeView.prototype.drawGlobe.call(this);

        this.countries.push(this.globe);
    },
    initGlobe: function() {
        BaseGlobeView.prototype.initGlobe.call(this);
